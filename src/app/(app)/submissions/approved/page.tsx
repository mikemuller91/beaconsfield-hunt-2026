  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-bold">Approved Submissions</h1>
        <span className="badge badge-approved">{submissions.length}</span>
      </div>

      {submissions.length === 0 ? (
        <div className="card-camo p-8 text-center">
          <CheckCircle className="w-12 h-12 text-[var(--muted-foreground)] mx-auto mb-4" />
          <p className="text-[var(--muted-foreground)]">No approved submissions yet</p>
        </div>
      ) : (
